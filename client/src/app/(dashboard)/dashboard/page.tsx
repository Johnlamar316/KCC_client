...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const timerId = setInterval(updateClockAndDate, 1000);
    updateClockAndDate();
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative">
        <div className="absolute top-4 right-4 bg-gray-800 text-white-50 px-4 py-2 rounded-lg shadow-md text-sm font-mono z-10">
          <div>{time}</div>
